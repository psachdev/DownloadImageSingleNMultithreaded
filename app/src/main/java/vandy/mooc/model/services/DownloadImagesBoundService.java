...
public class DownloadImagesBoundService 
	...
	public void handleMessage(Message message) {
		...
		new Runnable() {
			...
			// TODO -- you fill in here.
				Uri downloadImagePath =
						NetUtils.downloadImage(mService.get(), uri, directoryPathName);

			// Send the path to the image file, url, and
			// requestCode back to the Activity via the
			// replyMessenger.
			// TODO -- you fill in here.
				sendPath(replyMessenger,downloadImagePath,uri, requestCode);
		    }
		};
	    ...
	    // the image and reply.
	    // TODO -- you fill in here.
		Thread thread = new Thread(downloadImageAndReply);
		thread.start();
	}
    ...
    public static Intent makeIntent(Context context) {
		...
		Intent intent = new Intent(context,
				DownloadImagesBoundService.class);
    ...
    public void onCreate() {
    	...
    	// TODO -- you fill in here.
		mRequestHandler = new RequestHandler(DownloadImagesBoundService.this);
